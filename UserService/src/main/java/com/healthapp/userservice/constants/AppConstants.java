...
public class AppConstants {
    ...
    public static final String GET_USER_BY_ID = "/users/read-by-id/{userId}";
    public static final String GET_ALL_USERS = "/users/get-all";
    public static final String CHANGE_PASSWORD = "/users/change-password/{userId}";
    ...
    public static final String UPDATE_PROFILE = "/users/profile/update/{userId}";
    ...
    public static final String UPDATE_CONTACT = "/users/contact/update/{userId}";
